    ...
    return (
        <div className = "projects-page">
            <motion.div initial ={{opacity:0, y:"-100vh"}} animate={{opacity:1, y:0}} transition={{duration:2, type: "spring"}}><h1 className="projects-header">PROJECTS</h1></motion.div>
                    ...
                    <div class="project"><a className="thumbnail-header" href='https://github.com/zahaanshapoorjee/The-RAT-Remote-Access-Trojan' target="_blank" rel="noreferrer"><img src={require('../Assets/p8.jpg')} alt="Failed to Load..." className="project-image"/></a><h1 className="thumbnail-header"><a className="thumbnail-header" href='https://github.com/zahaanshapoorjee/The-RAT-Remote-Access-Trojan' target="_blank" rel="noreferrer">The RAT (Remote Access Trojan  with Botnet)</a></h1><p class="project-info">Skills Used: C++, Python, Networks</p></div>
                    ...
                    <div class="project"><a className="thumbnail-header" href='https://ashokapl.in/' target="_blank" rel="noreferrer"><img src={require('../Assets/p6.png')} alt="Failed to Load..." className="project-image"/></a><h1 className="thumbnail-header"><a className="thumbnail-header" href='https://ashokapl.in/' target="_blank" rel="noreferrer">Ashoka Premier League Website</a></h1><p class="project-info">Skills Used: MERN Stack, Google API</p></div>
                    <div class="project"><a className="thumbnail-header" href='https://github.com/zahaanshapoorjee/Penta-Cypher-Encryption-Decryption-Program' target="_blank" rel="noreferrer"><img src={require('../Assets/p7.jpg')} alt="Failed to Load..." className="project-image"/></a><h1 className="thumbnail-header"><a className="thumbnail-header" href='https://github.com/zahaanshapoorjee/Penta-Cypher-Encryption-Decryption-Program' target="_blank" rel="noreferrer">Penta-Cypher Encryption Decryption Program</a></h1><p class="project-info">Skills Used: C++, Cryprography</p></div>
                    </div>    
            </motion.div>            
        <SocialMedia/>
        </div>
